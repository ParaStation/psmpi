...
PATH="${PARASTATION_MPI}/bin${PATH:+:}${PATH}"
CPATH="${PARASTATION_MPI}/include${CPATH:+:}${CPATH}"
LD_LIBRARY_PATH="${PARASTATION_MPI}/lib${LD_LIBRARY_PATH:+:}${LD_LIBRARY_PATH}"
LIBRARY_PATH="${PARASTATION_MPI}/lib${LIBRARY_PATH:+:}${LIBRARY_PATH}"
```
