...
# SYNOPSIS
#
#   AX_CHECK_LIB(VARIABLE-PREFIX, HEADER-FILE, LIBRARY-FILE, [FUNCTION]
...
# NOTE
#
#   This is a modified version of AX_CHECK_LIBRARY that not only supports
#   testing for a given library, but also for checking if a given function is
#   provided as part of the library's API.
#
#   Example:
#
#     AX_CHECK_LIB([LIBEVENT], [event.h], [event], [evtimer_new], [],
