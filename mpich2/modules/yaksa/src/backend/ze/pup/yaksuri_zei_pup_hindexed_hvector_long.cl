...
__kernel void yaksuri_zei_kernel_pack_hindexed_hvector_long(__global const void *inbuf, __global void *outbuf, unsigned long count, __global const yaksuri_zei_md_s *__restrict__ md)
{
    ...
    *((long *) (void *) (dbuf + idx * sizeof(long))) = *((const long *) (const void *) (sbuf + x0 * extent + array_of_displs1[x1] + x2 * extent2 + x3 * stride2 + x4 * sizeof(long)));
}

__kernel void yaksuri_zei_kernel_unpack_hindexed_hvector_long(__global const void *inbuf, __global void *outbuf, unsigned long count, __global const yaksuri_zei_md_s *__restrict__ md)
{
    __global const char *__restrict__ sbuf = (__global char *) inbuf;
    __global char *__restrict__ dbuf = (__global char *) outbuf;
    ...
    intptr_t stride2 = md->u.hindexed.child->u.hvector.stride;
    uintptr_t extent2 = md->u.hindexed.child->extent;
    *((long *) (void *) (dbuf + x0 * extent + array_of_displs1[x1] + x2 * extent2 + x3 * stride2 + x4 * sizeof(long))) = *((const long *) (const void *) (sbuf + idx * sizeof(long)));
}

__kernel void yaksuri_zei_kernel_pack_hvector_hindexed_hvector_long(__global const void *inbuf, __global void *outbuf, unsigned long count, __global const yaksuri_zei_md_s *__restrict__ md)
{
    __global const char *__restrict__ sbuf = (__global char *) inbuf;
    __global char *__restrict__ dbuf = (__global char *) outbuf;
    sbuf = (__global const char *) ((__global char *)sbuf - md->true_lb);
    ...
    *((long *) (void *) (dbuf + idx * sizeof(long))) = *((const long *) (const void *) (sbuf + x0 * extent + x1 * stride1 + x2 * extent2 + array_of_displs2[x3] + x4 * extent3 + x5 * stride3 + x6 * sizeof(long)));
}

__kernel void yaksuri_zei_kernel_unpack_hvector_hindexed_hvector_long(__global const void *inbuf, __global void *outbuf, unsigned long count, __global const yaksuri_zei_md_s *__restrict__ md)
{
    __global const char *__restrict__ sbuf = (__global char *) inbuf;
    __global char *__restrict__ dbuf = (__global char *) outbuf;
    dbuf = dbuf - md->true_lb;
    ...
    intptr_t stride3 = md->u.hvector.child->u.hindexed.child->u.hvector.stride;
    uintptr_t extent3 = md->u.hvector.child->u.hindexed.child->extent;
    *((long *) (void *) (dbuf + x0 * extent + x1 * stride1 + x2 * extent2 + array_of_displs2[x3] + x4 * extent3 + x5 * stride3 + x6 * sizeof(long))) = *((const long *) (const void *) (sbuf + idx * sizeof(long)));
}

__kernel void yaksuri_zei_kernel_pack_blkhindx_hindexed_hvector_long(__global const void *inbuf, __global void *outbuf, unsigned long count, __global const yaksuri_zei_md_s *__restrict__ md)
{
    __global const char *__restrict__ sbuf = (__global char *) inbuf;
    __global char *__restrict__ dbuf = (__global char *) outbuf;
    sbuf = (__global const char *) ((__global char *)sbuf - md->true_lb);
    ...
    *((long *) (void *) (dbuf + idx * sizeof(long))) = *((const long *) (const void *) (sbuf + x0 * extent + array_of_displs1[x1] + x2 * extent2 + array_of_displs2[x3] + x4 * extent3 + x5 * stride3 + x6 * sizeof(long)));
}

__kernel void yaksuri_zei_kernel_unpack_blkhindx_hindexed_hvector_long(__global const void *inbuf, __global void *outbuf, unsigned long count, __global const yaksuri_zei_md_s *__restrict__ md)
{
    __global const char *__restrict__ sbuf = (__global char *) inbuf;
    __global char *__restrict__ dbuf = (__global char *) outbuf;
    dbuf = dbuf - md->true_lb;
    ...
    intptr_t stride3 = md->u.blkhindx.child->u.hindexed.child->u.hvector.stride;
    uintptr_t extent3 = md->u.blkhindx.child->u.hindexed.child->extent;
    *((long *) (void *) (dbuf + x0 * extent + array_of_displs1[x1] + x2 * extent2 + array_of_displs2[x3] + x4 * extent3 + x5 * stride3 + x6 * sizeof(long))) = *((const long *) (const void *) (sbuf + idx * sizeof(long)));
}

__kernel void yaksuri_zei_kernel_pack_hindexed_hindexed_hvector_long(__global const void *inbuf, __global void *outbuf, unsigned long count, __global const yaksuri_zei_md_s *__restrict__ md)
{
    __global const char *__restrict__ sbuf = (__global char *) inbuf;
    __global char *__restrict__ dbuf = (__global char *) outbuf;
    sbuf = (__global const char *) ((__global char *)sbuf - md->true_lb);
...
__kernel void yaksuri_zei_kernel_unpack_hindexed_hindexed_hvector_long(__global const void *inbuf, __global void *outbuf, unsigned long count, __global const yaksuri_zei_md_s *__restrict__ md)
{
    __global const char *__restrict__ sbuf = (__global char *) inbuf;
    __global char *__restrict__ dbuf = (__global char *) outbuf;
    dbuf = dbuf - md->true_lb;
...
__kernel void yaksuri_zei_kernel_pack_contig_hindexed_hvector_long(__global const void *inbuf, __global void *outbuf, unsigned long count, __global const yaksuri_zei_md_s *__restrict__ md)
{
    __global const char *__restrict__ sbuf = (__global char *) inbuf;
    __global char *__restrict__ dbuf = (__global char *) outbuf;
    sbuf = (__global const char *) ((__global char *)sbuf - md->true_lb);
    ...
    *((long *) (void *) (dbuf + idx * sizeof(long))) = *((const long *) (const void *) (sbuf + x0 * extent + x1 * stride1 + array_of_displs2[x2] + x3 * extent3 + x4 * stride3 + x5 * sizeof(long)));
}

__kernel void yaksuri_zei_kernel_unpack_contig_hindexed_hvector_long(__global const void *inbuf, __global void *outbuf, unsigned long count, __global const yaksuri_zei_md_s *__restrict__ md)
{
    __global const char *__restrict__ sbuf = (__global char *) inbuf;
    __global char *__restrict__ dbuf = (__global char *) outbuf;
    dbuf = dbuf - md->true_lb;
    ...
    intptr_t stride3 = md->u.contig.child->u.hindexed.child->u.hvector.stride;
    uintptr_t extent3 = md->u.contig.child->u.hindexed.child->extent;
    *((long *) (void *) (dbuf + x0 * extent + x1 * stride1 + array_of_displs2[x2] + x3 * extent3 + x4 * stride3 + x5 * sizeof(long))) = *((const long *) (const void *) (sbuf + idx * sizeof(long)));
}

__kernel void yaksuri_zei_kernel_pack_resized_hindexed_hvector_long(__global const void *inbuf, __global void *outbuf, unsigned long count, __global const yaksuri_zei_md_s *__restrict__ md)
{
    __global const char *__restrict__ sbuf = (__global char *) inbuf;
    __global char *__restrict__ dbuf = (__global char *) outbuf;
    sbuf = (__global const char *) ((__global char *)sbuf - md->true_lb);
    ...
    *((long *) (void *) (dbuf + idx * sizeof(long))) = *((const long *) (const void *) (sbuf + x0 * extent + array_of_displs2[x1] + x2 * extent3 + x3 * stride3 + x4 * sizeof(long)));
}

__kernel void yaksuri_zei_kernel_unpack_resized_hindexed_hvector_long(__global const void *inbuf, __global void *outbuf, unsigned long count, __global const yaksuri_zei_md_s *__restrict__ md)
{
    __global const char *__restrict__ sbuf = (__global char *) inbuf;
    __global char *__restrict__ dbuf = (__global char *) outbuf;
    dbuf = dbuf - md->true_lb;
    ...
    intptr_t stride3 = md->u.resized.child->u.hindexed.child->u.hvector.stride;
    uintptr_t extent3 = md->u.resized.child->u.hindexed.child->extent;
    *((long *) (void *) (dbuf + x0 * extent + array_of_displs2[x1] + x2 * extent3 + x3 * stride3 + x4 * sizeof(long))) = *((const long *) (const void *) (sbuf + idx * sizeof(long)));
}
