...
int yaksuri_zei_populate_pupfns_hindexed_builtin(yaksi_type_s * type)
{
    ...
    switch (type->u.hindexed.child->u.builtin.handle) {
        ...
        if (max_nesting_level >= 1) {
            ze->pack = yaksuri_zei_pack_hindexed_char;
            ze->unpack = yaksuri_zei_unpack_hindexed_char;
        }
        break;
        case YAKSA_TYPE__INT:
        if (max_nesting_level >= 1) {
            ze->pack = yaksuri_zei_pack_hindexed_int;
            ze->unpack = yaksuri_zei_unpack_hindexed_int;
        }
        break;
        case YAKSA_TYPE__SHORT:
        if (max_nesting_level >= 1) {
            ze->pack = yaksuri_zei_pack_hindexed_short;
            ze->unpack = yaksuri_zei_unpack_hindexed_short;
        }
        break;
        case YAKSA_TYPE__LONG:
        if (max_nesting_level >= 1) {
            ze->pack = yaksuri_zei_pack_hindexed_long;
            ze->unpack = yaksuri_zei_unpack_hindexed_long;
        }
        break;
        case YAKSA_TYPE__INT8_T:
        if (max_nesting_level >= 1) {
            ze->pack = yaksuri_zei_pack_hindexed_int8_t;
            ze->unpack = yaksuri_zei_unpack_hindexed_int8_t;
        }
        break;
        case YAKSA_TYPE__INT16_T:
        if (max_nesting_level >= 1) {
            ze->pack = yaksuri_zei_pack_hindexed_int16_t;
            ze->unpack = yaksuri_zei_unpack_hindexed_int16_t;
        }
        break;
        case YAKSA_TYPE__INT32_T:
        if (max_nesting_level >= 1) {
            ze->pack = yaksuri_zei_pack_hindexed_int32_t;
            ze->unpack = yaksuri_zei_unpack_hindexed_int32_t;
        }
        break;
        case YAKSA_TYPE__INT64_T:
        if (max_nesting_level >= 1) {
            ze->pack = yaksuri_zei_pack_hindexed_int64_t;
            ze->unpack = yaksuri_zei_unpack_hindexed_int64_t;
        }
        break;
        case YAKSA_TYPE__FLOAT:
        if (max_nesting_level >= 1) {
            ze->pack = yaksuri_zei_pack_hindexed_float;
            ze->unpack = yaksuri_zei_unpack_hindexed_float;
        }
        break;
        case YAKSA_TYPE__DOUBLE:
        if (max_nesting_level >= 1) {
            ze->pack = yaksuri_zei_pack_hindexed_double;
            ze->unpack = yaksuri_zei_unpack_hindexed_double;
        }
        break;
