...
int yaksuri_zei_populate_pupfns_resized_builtin(yaksi_type_s * type)
{
    ...
    switch (type->u.resized.child->u.builtin.handle) {
        ...
        if (max_nesting_level >= 1) {
            ze->pack = yaksuri_zei_pack_resized_char;
            ze->unpack = yaksuri_zei_unpack_resized_char;
        }
        break;
        case YAKSA_TYPE__INT:
        if (max_nesting_level >= 1) {
            ze->pack = yaksuri_zei_pack_resized_int;
            ze->unpack = yaksuri_zei_unpack_resized_int;
        }
        break;
        case YAKSA_TYPE__SHORT:
        if (max_nesting_level >= 1) {
            ze->pack = yaksuri_zei_pack_resized_short;
            ze->unpack = yaksuri_zei_unpack_resized_short;
        }
        break;
        case YAKSA_TYPE__LONG:
        if (max_nesting_level >= 1) {
            ze->pack = yaksuri_zei_pack_resized_long;
            ze->unpack = yaksuri_zei_unpack_resized_long;
        }
        break;
        case YAKSA_TYPE__INT8_T:
        if (max_nesting_level >= 1) {
            ze->pack = yaksuri_zei_pack_resized_int8_t;
            ze->unpack = yaksuri_zei_unpack_resized_int8_t;
        }
        break;
        case YAKSA_TYPE__INT16_T:
        if (max_nesting_level >= 1) {
            ze->pack = yaksuri_zei_pack_resized_int16_t;
            ze->unpack = yaksuri_zei_unpack_resized_int16_t;
        }
        break;
        case YAKSA_TYPE__INT32_T:
        if (max_nesting_level >= 1) {
            ze->pack = yaksuri_zei_pack_resized_int32_t;
            ze->unpack = yaksuri_zei_unpack_resized_int32_t;
        }
        break;
        case YAKSA_TYPE__INT64_T:
        if (max_nesting_level >= 1) {
            ze->pack = yaksuri_zei_pack_resized_int64_t;
            ze->unpack = yaksuri_zei_unpack_resized_int64_t;
        }
        break;
        case YAKSA_TYPE__FLOAT:
        if (max_nesting_level >= 1) {
            ze->pack = yaksuri_zei_pack_resized_float;
            ze->unpack = yaksuri_zei_unpack_resized_float;
        }
        break;
        case YAKSA_TYPE__DOUBLE:
        if (max_nesting_level >= 1) {
            ze->pack = yaksuri_zei_pack_resized_double;
            ze->unpack = yaksuri_zei_unpack_resized_double;
        }
        break;
