...
int main(int argc, char **argv)
{
    ...
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**mpix_comm_remote_group_failed", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**mpix_comm_remote_group_failed" );
    {
    /* src/mpi/comm/comm_remote_group_failed.c */
    int i1 = MPI_COMM_WORLD;
    char s2[] = "pointer2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**mpix_comm_remote_group_failed", "**mpix_comm_remote_group_failed %C %p", i1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**mpix_comm_remote_group_failed %C %p" );
    }
    ...
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**mpix_comm_reenable_anysource", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**mpix_comm_reenable_anysource" );
    {
    /* src/mpi/comm/comm_reenable_anysource.c */
    int i1 = MPI_COMM_WORLD;
    char s2[] = "pointer2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**mpix_comm_reenable_anysource", "**mpix_comm_reenable_anysource %C %p", i1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**mpix_comm_reenable_anysource %C %p" );
    }
    ...
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**mpix_comm_group_failed", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**mpix_comm_group_failed" );
    {
    /* src/mpi/comm/comm_group_failed.c */
    int i1 = MPI_COMM_WORLD;
    char s2[] = "pointer2";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**mpix_comm_group_failed", "**mpix_comm_group_failed %C %p", i1, s2 );
    ChkMsg( err, MPI_ERR_OTHER, "**mpix_comm_group_failed %C %p" );
    }
