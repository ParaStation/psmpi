...
static const char short_spc333[] = "**notimpl %s";
static const char long_spc333[]  = "Function %s not implemented";
static const char short_spc334[] = "**notsame %s %s";
static const char long_spc334[]  = "Inconsistent arguments %s to collective routine %s";
static const char short_spc335[] = "**nulledge %d %d";
static const char long_spc335[]  = "Edge for node %d (entry edges[%d]) is to itself";
static const char short_spc336[] = "**nullptr %s";
static const char long_spc336[]  = "Null pointer in parameter %s";
static const char short_spc337[] = "**nullptrtype %s";
static const char long_spc337[]  = "Null %s pointer";
static const char short_spc338[] = "**open %s";
static const char long_spc338[]  = "open failed - %s";
static const char short_spc339[] = "**open %s %d %d";
static const char long_spc339[]  = "open(%s) failed for process %d, error %d";
static const char short_spc340[] = "**opnotpredefined %d";
static const char long_spc340[]  = "only predefined ops are valid (op = %d)";
static const char short_spc341[] = "**opundefined %s";
static const char long_spc341[]  = "MPI_Op %s operation not defined for this datatype ";
static const char short_spc342[] = "**pglookup %s";
static const char long_spc342[]  = "unable to find the process group structure with id <%s>";
static const char short_spc343[] = "**pkt_ptr %p %p";
static const char long_spc343[]  = "invalid shm queue packet pointer (%p != %p)";
static const char short_spc344[] = "**pmi_barrier %d";
static const char long_spc344[]  = "PMI_Barrier returned %d";
static const char short_spc345[] = "**pmi_get_appnum %d";
static const char long_spc345[]  = "PMI_Get_appnum returned %d";
static const char short_spc346[] = "**pmi_get_clique_ranks %d";
static const char long_spc346[]  = "PMI_Get_clique_ranks returned %d";
static const char short_spc347[] = "**pmi_get_clique_size %d";
static const char long_spc347[]  = "PMI_Get_clique_size returned %d";
static const char short_spc348[] = "**pmi_get_id %d";
static const char long_spc348[]  = "PMI_Get_id returned %d";
static const char short_spc349[] = "**pmi_get_id_length_max %d";
static const char long_spc349[]  = "PMI_Get_id_length_max returned %d";
static const char short_spc350[] = "**pmi_get_rank %d";
static const char long_spc350[]  = "PMI_Get_rank returned %d";
static const char short_spc351[] = "**pmi_get_size %d";
static const char long_spc351[]  = "PMI_Get_size returned %d";
static const char short_spc352[] = "**pmi_get_universe_size %d";
static const char long_spc352[]  = "PMI_Get_universe_size returned %d";
static const char short_spc353[] = "**pmi_init %d";
static const char long_spc353[]  = "PMI_Init returned %d";
static const char short_spc354[] = "**pmi_invalid_clique_size %d";
static const char long_spc354[]  = "PMI_Get_clique_ranks returned an invalid size %d";
static const char short_spc355[] = "**pmi_kvs_commit %d";
static const char long_spc355[]  = "PMI_KVS_Commit returned %d";
static const char short_spc356[] = "**pmi_kvs_get %d";
static const char long_spc356[]  = "PMI_KVS_Get returned %d";
static const char short_spc357[] = "**pmi_kvs_get_key_length_max %d";
static const char long_spc357[]  = "PMI_KVS_Get_key_length_max returned %d";
static const char short_spc358[] = "**pmi_kvs_get_my_name %d";
static const char long_spc358[]  = "PMI_KVS_Get_my_name returned %d";
static const char short_spc359[] = "**pmi_kvs_get_name_length_max %d";
static const char long_spc359[]  = "PMI_KVS_Get_name_length_max returned %d";
static const char short_spc360[] = "**pmi_kvs_get_value_length_max %d";
static const char long_spc360[]  = "PMI_KVS_Get_value_length_max returned %d";
static const char short_spc361[] = "**pmi_kvs_put %d";
static const char long_spc361[]  = "PMI_KVS_Put returned %d";
static const char short_spc362[] = "**pmi_spawn_multiple %d";
static const char long_spc362[]  = "PMI_Spawn_multiple returned %d";
static const char short_spc363[] = "**post_connect %s";
static const char long_spc363[]  = "%s failed in VC_post_connect";
static const char short_spc364[] = "**rangedup %d %d %d";
static const char long_spc364[]  = "The range array specifies duplicate entries; process %d specified in range array %d was previously specified in range array %d";
static const char short_spc365[] = "**rangeendinvalid %d %d %d";
static const char long_spc365[]  = "The %dth element of a range array ends at %d but must be nonnegative and less than %d";
static const char short_spc366[] = "**rangestartinvalid %d %d %d";
static const char long_spc366[]  = "The %dth element of a range array starts at %d but must be nonnegative and less than %d";
static const char short_spc367[] = "**rank %d %d";
static const char long_spc367[]  = "Invalid rank has value %d but must be nonnegative and less than %d";
static const char short_spc368[] = "**rankarray %d %d %d";
static const char long_spc368[]  = "Invalid rank in rank array at index %d; value is %d but must be in the range 0 to %d";
static const char short_spc369[] = "**rankdup %d %d %d";
static const char long_spc369[]  = "Duplicate ranks in rank array at index %d, has value %d which is also the value at index %d";
static const char short_spc370[] = "**ranklocal %d %d";
static const char long_spc370[]  = "Error specifying local_leader; rank given was %d but must be in the range 0 to %d";
static const char short_spc371[] = "**rankremote %d %d";
static const char long_spc371[]  = "Error specifying remote_leader; rank given was %d but must be in the range 0 to %d";
static const char short_spc372[] = "**read %s";
static const char long_spc372[]  = "read from socket failed - %s";
static const char short_spc373[] = "**remove_shar_mem %s %s";
static const char long_spc373[]  = "unable to remove shared memory - %s %s";
static const char short_spc374[] = "**request_invalid_kind %d";
static const char long_spc374[]  = "The supplied request was invalid (kind=%d)";
static const char short_spc375[] = "**rmasize %d";
static const char long_spc375[]  = "Invalid size argument in RMA call (value is %d)";
static const char short_spc376[] = "**root %d";
static const char long_spc376[]  = "Invalid root (value given was %d)";
static const char short_spc377[] = "**rsendnomatch %d %d";
static const char long_spc377[]  = "Ready send from source %d and with tag %d had no matching receive";
static const char short_spc378[] = "**select %s";
static const char long_spc378[]  = "select failed - %s";
static const char short_spc379[] = "**setsockopt %s";
static const char long_spc379[]  = "setsockopt failed - %s";
static const char short_spc380[] = "**shm_op %d";
static const char long_spc380[]  = "invalid shm operation (%d)";
static const char short_spc381[] = "**shm_open %s %d";
static const char long_spc381[]  = "unable to open shared memory object %s (errno %d)";
static const char short_spc382[] = "**shm_unlink %s %d";
static const char long_spc382[]  = "failed to unlink shared memory object %s, error %d";
static const char short_spc383[] = "**shmat %d";
static const char long_spc383[]  = "shmat failed, error %d";
static const char short_spc384[] = "**shmctl %d %d";
static const char long_spc384[]  = "failed to mark the sysv segment %d for removal, error %d";
static const char short_spc385[] = "**shmget %d";
static const char long_spc385[]  = "shmget failed, error %d";
static const char short_spc386[] = "**shmhost %s %s";
static const char long_spc386[]  = "process not on the same host (%s != %s)";
static const char short_spc387[] = "**shmq_index %d %d";
static const char long_spc387[]  = "invalid shm queue index (%d > %d)";
static const char short_spc388[] = "**shmsize %d";
static const char long_spc388[]  = "Shared memory subsystem unable to allocate a block of the requested size, %d bytes";
static const char short_spc389[] = "**shutdown %s %d";
static const char long_spc389[]  = "shutdown failed, %s (errno %d)";
static const char short_spc390[] = "**snprintf %d";
static const char long_spc390[]  = "snprintf returned %d";
static const char short_spc391[] = "**sock_connect %s %d %s %d";
static const char long_spc391[]  = "unable to connect to %s on port %d, %s (errno %d)";
static const char short_spc392[] = "**sock_create %s %d";
static const char long_spc392[]  = "unable to create a socket, %s (errno %d)";
static const char short_spc393[] = "**sock_gethost %s %d";
static const char long_spc393[]  = "gethostname failed, %s (errno %d)";
static const char short_spc394[] = "**socket %s %d";
static const char long_spc394[]  = "WSASocket failed, %s (errno %d)";
static const char short_spc395[] = "**sock|badiovn %d %d %d";
static const char long_spc395[]  = "size of iov is invalid (set=%d,sock=%d,iov_n=%d)";
static const char short_spc396[] = "**sock|badlen %d %d %d %d";
static const char long_spc396[]  = "bad length parameter(s) (set=%d,sock=%d,min=%d,max=%d)";
static const char short_spc397[] = "**sock|badport %d";
static const char long_spc397[]  = "port number is out of range (sock=%d)";
static const char short_spc398[] = "**sock|close_cancel %d %d";
static const char long_spc398[]  = "operation cancelled because sock was closed locally (set=%d,sock=%d)";
static const char short_spc399[] = "**sock|closing %d %d";
static const char long_spc399[]  = "sock is in the process of being closed locally (set=%d,sock=%d)";
static const char short_spc400[] = "**sock|closing_already %d %d";
static const char long_spc400[]  = "a close operation is already post (set=%d,sock=%d)";
static const char short_spc401[] = "**sock|connclosed %d %d";
static const char long_spc401[]  = "connection closed by peer (set=%d,sock=%d)";
static const char short_spc402[] = "**sock|listener_bad_sock %d %d";
static const char long_spc402[]  = "supplied sock is not a listener (set=%d,sock=%d)";
static const char short_spc403[] = "**sock|listener_bad_state %d %d %d";
static const char long_spc403[]  = "supplied listener sock is in a bad state (set=%d,sock=%d,state=%d)";
static const char short_spc404[] = "**sock|listener_read %d %d";
static const char long_spc404[]  = "read operation not allowed on a listener (set=%d,sock=%d)";
static const char short_spc405[] = "**sock|listener_write %d %d";
static const char long_spc405[]  = "write operation not allowed on a listener (set=%d,sock=%d)";
static const char short_spc406[] = "**sock|notconnected %d %d";
static const char long_spc406[]  = "sock is not connected (set=%d,sock=%d)";
static const char short_spc407[] = "**sock|osnomem %s %d %d";
static const char long_spc407[]  = "operating system routine %s failed due to lack of memory (set=%d,sock=%d)";
static const char short_spc408[] = "**sock|poll|accept %d %s";
static const char long_spc408[]  = "accept failed to acquire a new socket (errno=%d:%s)";
static const char short_spc409[] = "**sock|poll|badbuf %d %d %d %s";
static const char long_spc409[]  = "the supplied buffer contains invalid memory (set=%d,sock=%d,errno=%d:%s)";
static const char short_spc410[] = "**sock|poll|badhandle %d %d %d";
static const char long_spc410[]  = "sock contains an invalid file descriptor (set=%d,sock=%d,fd=%d)";
static const char short_spc411[] = "**sock|poll|badhandle %d %d %d %d";
static const char long_spc411[]  = "sock contains an invalid file descriptor (set=%d,sock=%d,fd=%d:%d)";
static const char short_spc412[] = "**sock|poll|bind %d %d %s";
static const char long_spc412[]  = "unable to bind socket to port (port=%d,errno=%d:%s)";
static const char short_spc413[] = "**sock|poll|connclosed %d %d %d %s";
static const char long_spc413[]  = "connection closed by peer (set=%d,sock=%d,errno=%d:%s)";
static const char short_spc414[] = "**sock|poll|connfailed %d %d %d %s";
static const char long_spc414[]  = "connection failure (set=%d,sock=%d,errno=%d:%s)";
static const char short_spc415[] = "**sock|poll|connrefused %d %d %s";
static const char long_spc415[]  = "connection refused (set=%d,sock=%d,host=%s)";
static const char short_spc416[] = "**sock|poll|eqfail %d %d %d";
static const char long_spc416[]  = "fatal error: failed to enqueue an event; event was lost (set=%d,sock=%d,op=%d)";
static const char short_spc417[] = "**sock|poll|getport %d %s";
static const char long_spc417[]  = "failed to obtain port number of listener (errno=%d:%s)";
static const char short_spc418[] = "**sock|poll|listen %d %s";
static const char long_spc418[]  = "listen() failed (errno=%d:%s)";
static const char short_spc419[] = "**sock|poll|nodelay %d %s";
static const char long_spc419[]  = "unable to set TCP no delay attribute on socket (errno=%d:%s)";
static const char short_spc420[] = "**sock|poll|nonblock %d %s";
static const char long_spc420[]  = "unable to set socket to nonblocking (errno=%d:%s)";
static const char short_spc421[] = "**sock|poll|oserror %d %d %d %s";
static const char long_spc421[]  = "unexpected operating system error (set=%d,sock=%d,errno=%d:%s)";
static const char short_spc422[] = "**sock|poll|oserror %d %s";
static const char long_spc422[]  = "unexpected operating system error (errno=%d:%s)";
static const char short_spc423[] = "**sock|poll|oserror %s %d %d %d %s";
static const char long_spc423[]  = "unpected operating system error from %s (set=%d,sock=%d,errno=%d:%s)";
static const char short_spc424[] = "**sock|poll|osnomem %d %d %d %s";
static const char long_spc424[]  = "operating system routine failed due to lack of memory (set=%d,sock=%d,errno=%d:%s)";
static const char short_spc425[] = "**sock|poll|pipe %d %s";
static const char long_spc425[]  = "unable to allocate pipe to wakeup a blocking poll() (errno=%d:%s)";
static const char short_spc426[] = "**sock|poll|pipenonblock %d %s";
static const char long_spc426[]  = "unable to set wakeup pipe to nonblocking (errno=%d:%s)";
static const char short_spc427[] = "**sock|poll|reuseaddr %d %s";
static const char long_spc427[]  = "unable to set reuseaddr attribute on socket (errno=%d:%s)";
static const char short_spc428[] = "**sock|poll|setrcvbufsz %d %d %s";
static const char long_spc428[]  = " unable to set the receive socket buffer size (size=%d,errno=%d:%s)";
static const char short_spc429[] = "**sock|poll|setsndbufsz %d %d %s";
static const char long_spc429[]  = " unable to set the send socket buffer size (size=%d,errno=%d:%s)";
static const char short_spc430[] = "**sock|poll|socket %d %s";
static const char long_spc430[]  = "unable to obtain new socket (errno=%d:%s)";
static const char short_spc431[] = "**sock|poll|unhandledstate %d";
static const char long_spc431[]  = "encountered an unexpected state (%d)";
static const char short_spc432[] = "**sock|poll|unhandledtype %d";
static const char long_spc432[]  = "encountered an unexpected sock type (%d)";
static const char short_spc433[] = "**sock|reads %d %d";
static const char long_spc433[]  = "attempt to perform multiple simultaneous reads (set=%d,sock=%d)";
static const char short_spc434[] = "**sock|writes %d %d";
static const char long_spc434[]  = "attempt to perform multiple simultaneous writes (set=%d,sock=%d)";
static const char short_spc435[] = "**stride %d %d %d";
static const char long_spc435[]  = "Range (start = %d, end = %d, stride = %d) does not terminate";
static const char short_spc436[] = "**tag %d";
static const char long_spc436[]  = "Invalid tag, value is %d";
static const char short_spc437[] = "**topotoolarge %d %d";
static const char long_spc437[]  = "Topology size %d is larger than communicator size (%d)";
static const char short_spc438[] = "**truncate %d %d";
static const char long_spc438[]  = "Message truncated; %d bytes received but buffer size is %d";
static const char short_spc439[] = "**truncate %d %d %d %d";
static const char long_spc439[]  = "Message from rank %d and tag %d truncated; %d bytes received but buffer size is %d";
static const char short_spc440[] = "**typeinitbadmem %d";
static const char long_spc440[]  = "%dth builtin datatype handle references invalid memory";
static const char short_spc441[] = "**typeinitfail %d";
static const char long_spc441[]  = "Did not initialize name for all of the predefined datatypes (only did first %d)";
static const char short_spc442[] = "**typematchsize %s %d";
static const char long_spc442[]  = "No MPI datatype available for typeclass %s and size %d";
static const char short_spc443[] = "**typenamelen %d";
static const char long_spc443[]  = "Specified datatype name is too long (%d characters)";
static const char short_spc444[] = "**unableToLoadDLL %s %s";
static const char long_spc444[]  = " Unable to load the dynamically loadable library %s for reason %s";
static const char short_spc445[] = "**unableToLoadDLLsym %s %s";
static const char long_spc445[]  = " Unable to find or load the symbol %s from a dynamically loaded library for reason %s";
static const char short_spc446[] = "**unknowngpid %d %d";
static const char long_spc446[]  = "Internal MPI error: Unknown gpid (%d)%d";
static const char short_spc447[] = "**usercancel %d";
static const char long_spc447[]  = "user request cancel function returned error code %d";
static const char short_spc448[] = "**usercopy %d";
static const char long_spc448[]  = "user copy function returned error code %d";
static const char short_spc449[] = "**userdel %d";
static const char long_spc449[]  = "user delete function returned error code %d";
static const char short_spc450[] = "**userfree %d";
static const char long_spc450[]  = "user request free function returned error code %d";
static const char short_spc451[] = "**userquery %d";
static const char long_spc451[]  = "user request query function returned error code %d";
static const char short_spc452[] = "**vc_state %d";
static const char long_spc452[]  = "invalid vc state (%d)";
static const char short_spc453[] = "**winunlockrank %d %d";
static const char long_spc453[]  = "Invalid rank argument %d, should be %d";
static const char short_spc454[] = "**write %s";
static const char long_spc454[]  = "write to socket failed - %s";
static const char short_spc455[] = "**wsasock %s %d";
static const char long_spc455[]  = "WSAStartup failed, %s (errno %d)";

static const int specific_msgs_len = 456;
