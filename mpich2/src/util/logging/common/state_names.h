...
static MPIU_State_defs mpich_states[] = {
    ...
    { MPID_STATE_MPIDI_ACQUIRE_LOCAL_LOCK, "MPIDI_CH3I_Acquire_local_lock", (const char *)0 },
    ...
    { MPID_STATE_MPIDI_SEND_FLUSH_MSG, "MPIDI_CH3I_Send_flush_msg", (const char *)0 },
    { MPID_STATE_MPIDI_SEND_LOCK_MSG, "MPIDI_CH3I_Send_lock_msg", (const char *)0 },
    { MPID_STATE_MPIDI_SEND_UNLOCK_MSG, "MPIDI_CH3I_Send_unlock_msg", (const char *)0 },
    { MPID_STATE_MPIDI_SHM_WIN_FREE, "MPIDI_SHM_Win_free", (const char *)0 },
    { MPID_STATE_MPIDI_SOCK_UPDATE_SOCK_SET, "MPIDI_Sock_update_sock_set", (const char *)0 },
    { MPID_STATE_MPIDI_WAIT_FOR_LOCK_GRANTED, "MPIDI_CH3I_Wait_for_lock_granted", (const char *)0 },
