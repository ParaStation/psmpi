...
static MPIU_State_defs mpich_states[] = {
    ...
    { MPID_STATE_INIT_ID, "init_id", (const char *)0 },
    ...
    { MPID_STATE_MPIDI_##state_name, "MPIDI_FUNC_NOTIMPL", (const char *)0 },
    ...
    { MPID_STATE_MPIDI_CH3I_SEND_IMMED_RMW_MSG, "MPIDI_CH3I_Send_immed_rmw_msg", (const char *)0 },
    ...
    { MPID_STATE_MPIDI_CH3I_WIN_ALLOCATE_SHARED, "MPIDI_CH3I_Win_allocate_shared", (const char *)0 },
    ...
    { MPID_STATE_MPIDI_CH3U_WIN_ALLOCATE_SHARED, "MPIDI_CH3U_Win_allocate_shared", (const char *)0 },
    ...
    { MPID_STATE_MPID_COMM_GROUP_FAILED, "MPID_Comm_group_failed", (const char *)0 },
    { MPID_STATE_MPID_COMM_REENABLE_ANYSOURCE, "MPID_Comm_reenable_anysource", (const char *)0 },
    { MPID_STATE_MPID_COMM_REMOTE_GROUP_FAILED, "MPID_Comm_remote_group_failed", (const char *)0 },
    ...
    { MPID_STATE_MPID_NEM_PTL_EV_SEND_HANDLER, "MPID_nem_ptl_ev_send_handler", (const char *)0 },
    ...
    { MPID_STATE_MPID_NEM_PTL_SEND_FINALIZE, "MPID_nem_ptl_send_finalize", (const char *)0 },
    { MPID_STATE_MPID_NEM_PTL_SEND_INIT, "MPID_nem_ptl_send_init", (const char *)0 },
    ...
    { MPID_STATE_MPIX_COMM_CREATE_GROUP, "MPIX_Comm_create_group", (const char *)0 },
    { MPID_STATE_MPIX_COMM_GROUP_FAILED, "MPIX_Comm_group_failed", (const char *)0 },
    { MPID_STATE_MPIX_COMM_IDUP, "MPIX_Comm_idup", (const char *)0 },
    { MPID_STATE_MPIX_COMM_REENABLE_ANYSOURCE, "MPIX_Comm_reenable_anysource", (const char *)0 },
    { MPID_STATE_MPIX_COMM_REMOTE_GROUP_FAILED, "MPIX_Comm_remote_group_failed", (const char *)0 },
    { MPID_STATE_MPIX_COMPARE_AND_SWAP, "MPIX_Compare_and_swap", (const char *)0 },
    { MPID_STATE_MPIX_FETCH_AND_OP, "MPIX_Fetch_and_op", (const char *)0 },
    { MPID_STATE_MPIX_GET_ACCUMULATE, "MPIX_Get_accumulate", (const char *)0 },
    { MPID_STATE_MPIX_IALLGATHER, "MPIX_Iallgather", (const char *)0 },
    { MPID_STATE_MPIX_IALLGATHERV, "MPIX_Iallgatherv", (const char *)0 },
    { MPID_STATE_MPIX_IALLREDUCE, "MPIX_Iallreduce", (const char *)0 },
    { MPID_STATE_MPIX_IALLTOALL, "MPIX_Ialltoall", (const char *)0 },
    { MPID_STATE_MPIX_IALLTOALLV, "MPIX_Ialltoallv", (const char *)0 },
    { MPID_STATE_MPIX_IALLTOALLW, "MPIX_Ialltoallw", (const char *)0 },
    { MPID_STATE_MPIX_IBARRIER, "MPIX_Ibarrier", (const char *)0 },
    { MPID_STATE_MPIX_IBCAST, "MPIX_Ibcast", (const char *)0 },
    { MPID_STATE_MPIX_IEXSCAN, "MPIX_Iexscan", (const char *)0 },
    { MPID_STATE_MPIX_IGATHER, "MPIX_Igather", (const char *)0 },
    { MPID_STATE_MPIX_IGATHERV, "MPIX_Igatherv", (const char *)0 },
    { MPID_STATE_MPIX_IMPROBE, "MPIX_Improbe", (const char *)0 },
    { MPID_STATE_MPIX_IMRECV, "MPIX_Imrecv", (const char *)0 },
    { MPID_STATE_MPIX_INEIGHBOR_ALLGATHER, "MPIX_Ineighbor_allgather", (const char *)0 },
    { MPID_STATE_MPIX_INEIGHBOR_ALLGATHERV, "MPIX_Ineighbor_allgatherv", (const char *)0 },
    { MPID_STATE_MPIX_INEIGHBOR_ALLTOALL, "MPIX_Ineighbor_alltoall", (const char *)0 },
    { MPID_STATE_MPIX_INEIGHBOR_ALLTOALLV, "MPIX_Ineighbor_alltoallv", (const char *)0 },
    { MPID_STATE_MPIX_INEIGHBOR_ALLTOALLW, "MPIX_Ineighbor_alltoallw", (const char *)0 },
    { MPID_STATE_MPIX_IREDUCE, "MPIX_Ireduce", (const char *)0 },
    { MPID_STATE_MPIX_IREDUCE_SCATTER, "MPIX_Ireduce_scatter", (const char *)0 },
    { MPID_STATE_MPIX_IREDUCE_SCATTER_BLOCK, "MPIX_Ireduce_scatter_block", (const char *)0 },
    { MPID_STATE_MPIX_ISCAN, "MPIX_Iscan", (const char *)0 },
    { MPID_STATE_MPIX_ISCATTER, "MPIX_Iscatter", (const char *)0 },
    { MPID_STATE_MPIX_ISCATTERV, "MPIX_Iscatterv", (const char *)0 },
    { MPID_STATE_MPIX_MPROBE, "MPIX_Mprobe", (const char *)0 },
    { MPID_STATE_MPIX_MRECV, "MPIX_Mrecv", (const char *)0 },
    { MPID_STATE_MPIX_NEIGHBOR_ALLGATHER, "MPIX_Neighbor_allgather", (const char *)0 },
    { MPID_STATE_MPIX_NEIGHBOR_ALLGATHERV, "MPIX_Neighbor_allgatherv", (const char *)0 },
    { MPID_STATE_MPIX_NEIGHBOR_ALLTOALL, "MPIX_Neighbor_alltoall", (const char *)0 },
    { MPID_STATE_MPIX_NEIGHBOR_ALLTOALLV, "MPIX_Neighbor_alltoallv", (const char *)0 },
    { MPID_STATE_MPIX_NEIGHBOR_ALLTOALLW, "MPIX_Neighbor_alltoallw", (const char *)0 },
    { MPID_STATE_MPIX_RACCUMULATE, "MPIX_Raccumulate", (const char *)0 },
    { MPID_STATE_MPIX_RGET, "MPIX_Rget", (const char *)0 },
    { MPID_STATE_MPIX_RGET_ACCUMULATE, "MPIX_Rget_accumulate", (const char *)0 },
    { MPID_STATE_MPIX_RPUT, "MPIX_Rput", (const char *)0 },
    { MPID_STATE_MPIX_WIN_ALLOCATE, "MPIX_Win_allocate", (const char *)0 },
    { MPID_STATE_MPIX_WIN_ALLOCATE_SHARED, "MPIX_Win_allocate_shared", (const char *)0 },
    { MPID_STATE_MPIX_WIN_ATTACH, "MPIX_Win_attach", (const char *)0 },
    { MPID_STATE_MPIX_WIN_CREATE_DYNAMIC, "MPIX_Win_create_dynamic", (const char *)0 },
    { MPID_STATE_MPIX_WIN_DETACH, "MPIX_Win_detach", (const char *)0 },
    { MPID_STATE_MPIX_WIN_FLUSH, "MPIX_Win_flush", (const char *)0 },
    { MPID_STATE_MPIX_WIN_FLUSH_ALL, "MPIX_Win_flush_all", (const char *)0 },
    { MPID_STATE_MPIX_WIN_FLUSH_LOCAL, "MPIX_Win_flush_local", (const char *)0 },
    { MPID_STATE_MPIX_WIN_FLUSH_LOCAL_ALL, "MPIX_Win_flush_local_all", (const char *)0 },
    { MPID_STATE_MPIX_WIN_LOCK_ALL, "MPIX_Win_lock_all", (const char *)0 },
    { MPID_STATE_MPIX_WIN_SHARED_QUERY, "MPIX_Win_shared_query", (const char *)0 },
    { MPID_STATE_MPIX_WIN_SYNC, "MPIX_Win_sync", (const char *)0 },
    { MPID_STATE_MPIX_WIN_UNLOCK_ALL, "MPIX_Win_unlock_all", (const char *)0 },
    ...
    { MPID_STATE_MPI_COMM_SPLIT_TYPE, "MPIX_Comm_split_type", (const char *)0 },
    ...
    { MPID_STATE_MPI_TYPE_CREATE_HINDEXED_BLOCK, "MPIX_Type_create_hindexed_block", (const char *)0 },
