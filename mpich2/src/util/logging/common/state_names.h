...
static MPIU_State_defs mpich_states[] = {
    ...
    { MPID_STATE_DO_PUT, "do_put", (const char *)0 },
    ...
    { MPID_STATE_HANDLE_SHM_READ, "handle_shm_read", (const char *)0 },
    ...
    { MPID_STATE_MPIDI_CH3I_SHM_ATTACH_NOTUNLINK_MEM, "MPIDI_CH3I_SHM_Attach_notunlink_mem", (const char *)0 },
    ...
    { MPID_STATE_MPIDI_CH3I_SHM_READ, "MPIDI_CH3I_SHM_read", (const char *)0 },
    ...
    { MPID_STATE_MPIDI_CH3I_SHM_UNLINK_AND_DETACH_MEM, "MPIDI_CH3I_SHM_Unlink_and_detach_mem", (const char *)0 },
    ...
    { MPID_STATE_MPIDI_CH3_ACCUMULATE, "MPIDI_CH3_Accumulate", (const char *)0 },
    { MPID_STATE_MPIDI_CH3_ALLOC_MEM, "MPIDI_CH3_Alloc_mem", (const char *)0 },
    ...
    { MPID_STATE_MPIDI_CH3_COMPLETE_UNIDIRECTIONAL_CONNECTION, "MPIDI_CH3_Complete_unidirectional_connection", (const char *)0 },
    { MPID_STATE_MPIDI_CH3_COMPLETE_UNIDIRECTIONAL_CONNECTION2, "MPIDI_CH3_Complete_unidirectional_connection2", (const char *)0 },
    ...
    { MPID_STATE_MPIDI_CH3_CONTINUE_PACKET_HANDLER, "MPIDI_CH3_continue_packet_handler", (const char *)0 },
    { MPID_STATE_MPIDI_CH3_CTS_PACKET_HANDLER, "MPIDI_CH3_CTS_packet_handler", (const char *)0 },
    { MPID_STATE_MPIDI_CH3_DO_CTS, "MPIDI_CH3_do_cts", (const char *)0 },
    { MPID_STATE_MPIDI_CH3_DO_RTS, "MPIDI_CH3_do_rts", (const char *)0 },
    { MPID_STATE_MPIDI_CH3_FINALIZE, "MPIDI_CH3_Finalize", (const char *)0 },
    { MPID_STATE_MPIDI_CH3_FREE_MEM, "MPIDI_CH3_Free_mem", (const char *)0 },
    { MPID_STATE_MPIDI_CH3_GET, "MPIDI_CH3_Get", (const char *)0 },
    ...
    { MPID_STATE_MPIDI_CH3_IREAD, "MPIDI_CH3_iRead", (const char *)0 },
    ...
    { MPID_STATE_MPIDI_CH3_IWRITE, "MPIDI_CH3_iWrite", (const char *)0 },
    ...
    { MPID_STATE_MPIDI_CH3_PUT, "MPIDI_CH3_Put", (const char *)0 },
    { MPID_STATE_MPIDI_CH3_RELOAD_IOV_OR_DONE_HANDLER, "MPIDI_CH3_reload_IOV_or_done_handler", (const char *)0 },
    { MPID_STATE_MPIDI_CH3_RELOAD_IOV_REPLY_HANDLER, "MPIDI_CH3_reload_IOV_reply_handler", (const char *)0 },
    ...
    { MPID_STATE_MPIDI_CH3_START_PACKET_HANDLER, "MPIDI_CH3_start_packet_handler", (const char *)0 },
    ...
    { MPID_STATE_MPIDI_CH3_WIN_COMPLETE, "MPIDI_CH3_Win_complete", (const char *)0 },
    { MPID_STATE_MPIDI_CH3_WIN_CREATE, "MPIDI_CH3_Win_create", (const char *)0 },
    { MPID_STATE_MPIDI_CH3_WIN_FENCE, "MPIDI_CH3_Win_fence", (const char *)0 },
    { MPID_STATE_MPIDI_CH3_WIN_FREE, "MPIDI_CH3_Win_free", (const char *)0 },
    { MPID_STATE_MPIDI_CH3_WIN_LOCK, "MPIDI_CH3_Win_lock", (const char *)0 },
    { MPID_STATE_MPIDI_CH3_WIN_POST, "MPIDI_CH3_Win_post", (const char *)0 },
    { MPID_STATE_MPIDI_CH3_WIN_START, "MPIDI_CH3_Win_start", (const char *)0 },
    { MPID_STATE_MPIDI_CH3_WIN_UNLOCK, "MPIDI_CH3_Win_unlock", (const char *)0 },
    { MPID_STATE_MPIDI_CH3_WIN_WAIT, "MPIDI_CH3_Win_wait", (const char *)0 },
    ...
    { MPID_STATE_MPIDU_ALLOC_BY_ID, "MPIDU_Alloc_by_id", (const char *)0 },
    { MPID_STATE_MPIDU_ALLOC_CALC_SIZE, "MPIDU_Alloc_calc_size", (const char *)0 },
    { MPID_STATE_MPIDU_ALLOC_CREATE_POOL, "MPIDU_Alloc_create_pool", (const char *)0 },
    { MPID_STATE_MPIDU_ALLOC_FREE, "MPIDU_Alloc_free", (const char *)0 },
    { MPID_STATE_MPIDU_COMPARE_SWAP, "MPIDU_Compare_swap", (const char *)0 },
    { MPID_STATE_MPIDU_OWNER_INIT, "MPIDU_Owner_init", (const char *)0 },
    { MPID_STATE_MPIDU_OWNER_RELEASE, "MPIDU_Owner_release", (const char *)0 },
    { MPID_STATE_MPIDU_OWNER_TRY_ACQUIRE, "MPIDU_Owner_try_acquire", (const char *)0 },
    ...
    { MPID_STATE_MPIDU_REF_ADD, "MPIDU_Ref_add", (const char *)0 },
    { MPID_STATE_MPIDU_REF_RELEASE_AND_TEST, "MPIDU_Ref_release_and_test", (const char *)0 },
    { MPID_STATE_MPIDU_SHM_BARRIER_ENTER, "MPIDU_Shm_barrier_enter", (const char *)0 },
    { MPID_STATE_MPIDU_SHM_BARRIER_INIT, "MPIDU_Shm_barrier_init", (const char *)0 },
    { MPID_STATE_MPIDU_SHM_BARRIER_RELEASE, "MPIDU_Shm_barrier_release", (const char *)0 },
    { MPID_STATE_MPIDU_SHM_BARRIER_SIMPLE, "MPIDU_Shm_barrier_simple", (const char *)0 },
    ...
    { MPID_STATE_MPID_NEM_ALLOCATE_SHARED_MEMORY, "MPID_nem_allocate_shared_memory", (const char *)0 },
    { MPID_STATE_MPID_NEM_ALLOCATE_SHM_REGION, "MPID_nem_allocate_shm_region", (const char *)0 },
    { MPID_STATE_MPID_NEM_ALT_TCP_MODULE_POLL, "MPID_nem_alt_tcp_module_poll", (const char *)0 },
    { MPID_STATE_MPID_NEM_ATTACH_SHARED_MEMORY, "MPID_nem_attach_shared_memory", (const char *)0 },
    ...
    { MPID_STATE_MPID_NEM_CHECK_ALLOC, "MPID_nem_check_alloc", (const char *)0 },
    ...
    { MPID_STATE_MPID_NEM_CKPT_SHUTDOWN, "MPID_nem_ckpt_shutdown", (const char *)0 },
    ...
    { MPID_STATE_MPID_NEM_DETACH_SHARED_MEMORY, "MPID_nem_detach_shared_memory", (const char *)0 },
    ...
    { MPID_STATE_MPID_NEM_GM_MODULE_SEND, "MPID_nem_gm_module_send", (const char *)0 },
    ...
    { MPID_STATE_MPID_NEM_NETWORK_POLL, "MPID_nem_network_poll", (const char *)0 },
    { MPID_STATE_MPID_NEM_NET_INIT, "MPID_nem_net_init", (const char *)0 },
    ...
    { MPID_STATE_MPID_NEM_NEWTCP_MODULE_GET_ADDR_PORT_FROM_BC, "MPID_nem_newtcp_module_get_addr_port_from_bc", (const char *)0 },
    ...
    { MPID_STATE_MPID_NEM_NEWTCP_MODULE_SEND_QUEUED, "send_queued", (const char *)0 },
    ...
    { MPID_STATE_MPID_NEM_REMOVE_SHARED_MEMORY, "MPID_nem_remove_shared_memory", (const char *)0 },
    { MPID_STATE_MPID_NEM_SEG_CREATE, "MPID_nem_seg_create", (const char *)0 },
    { MPID_STATE_MPID_NEM_SEG_DESTROY, "MPID_nem_seg_destroy", (const char *)0 },
    ...
    { MPID_STATE_MPID_NEM_TCP_MODULE_CKPT_SHUTDOWN, "MPID_nem_tcp_module_ckpt_shutdown", (const char *)0 },
    { MPID_STATE_MPID_NEM_TCP_MODULE_CONNECT_TO_ROOT, "MPID_nem_tcp_module_connect_to_root", (const char *)0 },
    { MPID_STATE_MPID_NEM_TCP_MODULE_FINALIZE, "MPID_nem_tcp_module_finalize", (const char *)0 },
    { MPID_STATE_MPID_NEM_TCP_MODULE_GET_BUSINESS_CARD, "MPID_nem_tcp_module_get_business_card", (const char *)0 },
    { MPID_STATE_MPID_NEM_TCP_MODULE_INIT, "MPID_nem_tcp_module_init", (const char *)0 },
    ...
    { MPID_STATE_MPID_NEM_TCP_MODULE_POLL, "MPID_nem_tcp_module_poll", (const char *)0 },
    { MPID_STATE_MPID_NEM_TCP_MODULE_POLL_RECV, "MPID_nem_tcp_module_poll_recv", (const char *)0 },
    { MPID_STATE_MPID_NEM_TCP_MODULE_POLL_SEND, "MPID_nem_tcp_module_poll_send", (const char *)0 },
    { MPID_STATE_MPID_NEM_TCP_MODULE_SEND, "MPID_nem_tcp_module_send", (const char *)0 },
    { MPID_STATE_MPID_NEM_TCP_MODULE_VC_DESTROY, "MPID_nem_tcp_module_vc_destroy", (const char *)0 },
    { MPID_STATE_MPID_NEM_TCP_MODULE_VC_INIT, "MPID_nem_tcp_module_vc_init", (const char *)0 },
    { MPID_STATE_MPID_NEM_TCP_MODULE_VC_TERMINATE, "MPID_nem_tcp_module_vc_terminate", (const char *)0 },
    { MPID_STATE_MPID_NEM_VC_DESTROY, "MPID_nem_vc_destroy", (const char *)0 },
    { MPID_STATE_MPID_NEM_VC_INIT, "MPID_nem_vc_init", (const char *)0 },
    { MPID_STATE_MPID_NEM_VC_TERMINATE, "MPID_nem_finalize", (const char *)0 },
    ...
    { MPID_STATE_NEM_SEG_ALLOC, "MPID_nem_seg_alloc", (const char *)0 },
    ...
    { MPID_STATE_SEND_ENQUEUEDV, "send_enqueuedv", (const char *)0 },
