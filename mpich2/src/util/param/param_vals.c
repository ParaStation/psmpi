...
int MPIR_PARAM_ALLTOALL_THROTTLE = 0; /* mpich 1.4 uses default 4. libpscom prefer 0. max
 no. of irecvs/isends posted at a time in some alltoall
 algorithms. Setting it to 0 causes all irecvs/isends to be posted at
 once. */
