...
extern FORT_DLL_SPEC void FORT_CALL pmpi_errhandler_create__( MPI_Handler_function*, MPI_Fint *, MPI_Fint * );
#endif
#ifndef F77_NAME_LOWER_USCORE
extern FORT_DLL_SPEC void FORT_CALL pmpi_errhandler_create_( MPI_Handler_function*, MPI_Fint *, MPI_Fint * );
#endif
...
#include "fproto.h"
FORT_DLL_SPEC void FORT_CALL mpi_errhandler_create_ ( MPI_Handler_function*v1, MPI_Fint *v2, MPI_Fint *ierr ){
