...
int MPIR_Send_init_cdesc(CFI_cdesc_t* x0, int x1, MPI_Datatype x2, int x3, int x4, MPI_Comm x5, MPI_Request * x6)
{
    int err = MPI_SUCCESS;
    ...
    err = MPI_Send_init(buf0, count0, dtype0, x3, x4, x5, x6);
