...
int MPIR_Ineighbor_allgatherv_cdesc(CFI_cdesc_t* x0, int x1, MPI_Datatype x2, CFI_cdesc_t* x3, const int x4[], const int x5[], MPI_Datatype x6, MPI_Comm x7, MPI_Request * x8)
{
    int err = MPI_SUCCESS;
    ...
    err = MPI_Ineighbor_allgatherv(buf0, count0, dtype0, buf3, x4, x5, x6, x7, x8);
