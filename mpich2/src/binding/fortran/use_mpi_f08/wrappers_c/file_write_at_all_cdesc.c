...
int MPIR_File_write_at_all_cdesc(MPI_File x0, MPI_Offset x1, CFI_cdesc_t* x2, int x3, MPI_Datatype x4, MPI_Status * x5)
{
    int err = MPI_SUCCESS;
    ...
    err = MPI_File_write_at_all(x0, x1, buf2, count2, dtype2, x5);
