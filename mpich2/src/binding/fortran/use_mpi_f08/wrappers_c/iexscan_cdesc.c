...
int MPIR_Iexscan_cdesc(CFI_cdesc_t* x0, CFI_cdesc_t* x1, int x2, MPI_Datatype x3, MPI_Op x4, MPI_Comm x5, MPI_Request * x6)
{
    int err = MPI_SUCCESS;
    ...
    err = MPI_Iexscan(buf0, buf1, count1, dtype1, x4, x5, x6);
