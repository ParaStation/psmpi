...
int MPIR_Rget_cdesc(CFI_cdesc_t* x0, int x1, MPI_Datatype x2, int x3, MPI_Aint x4, int x5, MPI_Datatype x6, MPI_Win x7, MPI_Request * x8)
{
    int err = MPI_SUCCESS;
    ...
    err = MPI_Rget(buf0, count0, dtype0, x3, x4, x5, x6, x7, x8);
