...
int MPIR_Ineighbor_alltoall_cdesc(CFI_cdesc_t* x0, int x1, MPI_Datatype x2, CFI_cdesc_t* x3, int x4, MPI_Datatype x5, MPI_Comm x6, MPI_Request * x7)
{
    int err = MPI_SUCCESS;
    ...
    err = MPI_Ineighbor_alltoall(buf0, count0, dtype0, buf3, count3, dtype3, x6, x7);
