...
extern FORT_DLL_SPEC void FORT_CALL mpi_win_allocate_ ( MPI_Fint *v1, MPI_Fint *v2, MPI_Fint *v3, MPI_Fint *v4, void*v5, MPI_Fint *v6, MPI_Fint *ierr ) FUNC_ATTRIBUTES(mpi_win_allocate_);
extern FORT_DLL_SPEC void FORT_CALL mpi_win_allocate_shared_ ( MPI_Fint *v1, MPI_Fint *v2, MPI_Fint *v3, MPI_Fint *v4, void*v5, MPI_Fint *v6, MPI_Fint *ierr ) FUNC_ATTRIBUTES(mpi_win_allocate_shared_);
...
extern FORT_DLL_SPEC void FORT_CALL mpi_win_attach_ ( MPI_Fint *v1, void*v2, MPI_Fint *v3, MPI_Fint *ierr ) FUNC_ATTRIBUTES(mpi_win_attach_);
...
extern FORT_DLL_SPEC void FORT_CALL mpi_get_accumulate_ ( void*v1, MPI_Fint *v2, MPI_Fint *v3, void*v4, MPI_Fint *v5, MPI_Fint *v6, MPI_Fint *v7, MPI_Fint *v8, MPI_Fint *v9, MPI_Fint *v10, MPI_Fint *v11, MPI_Fint *v12, MPI_Fint *ierr ) FUNC_ATTRIBUTES(mpi_get_accumulate_);
extern FORT_DLL_SPEC void FORT_CALL mpi_fetch_and_op_ ( void*v1, void*v2, MPI_Fint *v3, MPI_Fint *v4, MPI_Fint *v5, MPI_Fint *v6, MPI_Fint *v7, MPI_Fint *ierr ) FUNC_ATTRIBUTES(mpi_fetch_and_op_);
extern FORT_DLL_SPEC void FORT_CALL mpi_compare_and_swap_ ( void*v1, void*v2, void*v3, MPI_Fint *v4, MPI_Fint *v5, MPI_Fint *v6, MPI_Fint *v7, MPI_Fint *ierr ) FUNC_ATTRIBUTES(mpi_compare_and_swap_);
extern FORT_DLL_SPEC void FORT_CALL mpi_rput_ ( void*v1, MPI_Fint *v2, MPI_Fint *v3, MPI_Fint *v4, MPI_Fint *v5, MPI_Fint *v6, MPI_Fint *v7, MPI_Fint *v8, MPI_Fint *v9, MPI_Fint *ierr ) FUNC_ATTRIBUTES(mpi_rput_);
extern FORT_DLL_SPEC void FORT_CALL mpi_rget_ ( void*v1, MPI_Fint *v2, MPI_Fint *v3, MPI_Fint *v4, MPI_Fint *v5, MPI_Fint *v6, MPI_Fint *v7, MPI_Fint *v8, MPI_Fint *v9, MPI_Fint *ierr ) FUNC_ATTRIBUTES(mpi_rget_);
extern FORT_DLL_SPEC void FORT_CALL mpi_raccumulate_ ( void*v1, MPI_Fint *v2, MPI_Fint *v3, MPI_Fint *v4, MPI_Fint *v5, MPI_Fint *v6, MPI_Fint *v7, MPI_Fint *v8, MPI_Fint *v9, MPI_Fint *v10, MPI_Fint *ierr ) FUNC_ATTRIBUTES(mpi_raccumulate_);
extern FORT_DLL_SPEC void FORT_CALL mpi_rget_accumulate_ ( void*v1, MPI_Fint *v2, MPI_Fint *v3, void*v4, MPI_Fint *v5, MPI_Fint *v6, MPI_Fint *v7, MPI_Fint *v8, MPI_Fint *v9, MPI_Fint *v10, MPI_Fint *v11, MPI_Fint *v12, MPI_Fint *v13, MPI_Fint *ierr ) FUNC_ATTRIBUTES(mpi_rget_accumulate_);
