...
void MPIDI_PSP_rma_put_origin_cb(pscom_request_t * req)
{
    ...
    win_ptr->rma_local_complete_rank[req->user->pscom_put.target_rank]++;
...
void MPIDI_PSP_rma_get_origin_cb(pscom_request_t * req)
{
    ...
    MPID_THREAD_WIN_LOCK_ENTER(win_ptr->win_lock_mutex);
    win_ptr->rma_local_complete_rank[req->user->pscom_get.target_rank]++;
    win_ptr->rma_local_complete_cnt++;
    MPID_THREAD_WIN_LOCK_EXIT(win_ptr->win_lock_mutex);
...
void MPIDI_PSP_rma_acc_origin_cb(pscom_request_t * req)
{
    ...
    MPID_THREAD_WIN_LOCK_ENTER(win_ptr->win_lock_mutex);
    win_ptr->rma_local_complete_rank[req->user->pscom_accumulate.target_rank]++;
    win_ptr->rma_local_complete_cnt++;
...
void MPIDI_PSP_rma_get_acc_origin_cb(pscom_request_t * req)
{
    ...
    MPID_THREAD_WIN_LOCK_ENTER(win_ptr->win_lock_mutex);
    win_ptr->rma_local_complete_rank[req->user->pscom_get_accumulate.target_rank]++;
    win_ptr->rma_local_complete_cnt++;
    MPID_THREAD_WIN_LOCK_EXIT(win_ptr->win_lock_mutex);
    /* This is an pscom.io_done call. Global lock state undefined! */
...
void MPIDI_PSP_rma_fetch_op_origin_cb(pscom_request_t * req)
{
    ...
    MPID_THREAD_WIN_LOCK_ENTER(win_ptr->win_lock_mutex);
    win_ptr->rma_local_complete_rank[req->user->pscom_fetch_op.target_rank]++;
    win_ptr->rma_local_complete_cnt++;
    MPID_THREAD_WIN_LOCK_EXIT(win_ptr->win_lock_mutex);
    pscom_request_free(req);
}
...
void MPIDI_PSP_rma_comp_swap_origin_cb(pscom_request_t * req)
{
    ...
    MPID_THREAD_WIN_LOCK_ENTER(win_ptr->win_lock_mutex);
    win_ptr->rma_local_complete_rank[req->user->pscom_compare_swap.target_rank]++;
    win_ptr->rma_local_complete_cnt++;
    MPID_THREAD_WIN_LOCK_EXIT(win_ptr->win_lock_mutex);
    pscom_request_free(req);
}
...
{
    MPIDI_PSCOM_RMA_API_get_t *xhead_rma = &req->xheader.rma_get.user;
    MPIR_Win *win_ptr = (MPIR_Win *) xhead_rma->remote_win;
    MPID_THREAD_WIN_LOCK_ENTER(win_ptr->win_lock_mutex);
    win_ptr->rma_target_total_received++;
    win_ptr->rma_source_rank_received[xhead_rma->source_rank]++;
