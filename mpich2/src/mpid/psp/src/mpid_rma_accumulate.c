...
void rma_accumulate_done(pscom_request_t * req)
{
    ...
    req->user->type.accumulate_send.win_ptr->rma_local_pending_rank[req->user->type.
                                                                    accumulate_send.target_rank]--;

    assert(req->user->type.accumulate_send.
           win_ptr->rma_pending_accumulates[req->user->type.accumulate_send.target_rank] == 1);
    req->user->type.accumulate_send.win_ptr->rma_pending_accumulates[req->user->
                                                                     type.accumulate_send.
                                                                     target_rank] = 0;
