...
static inline int MPID_PSP_packed_msg_allocate(size_t data_sz, MPID_PSP_packed_msg_t * msg)
{
...
static inline int MPID_PSP_packed_msg_need_pack(const MPID_PSP_packed_msg_t * msg)
{
    return ! !msg->tmp_buf;
}
...
static inline int MPID_PSP_packed_msg_need_unpack(const MPID_PSP_packed_msg_t * msg)
{
    return ! !msg->tmp_buf;
}
...
static inline void MPID_PSP_packed_msg_cleanup(MPID_PSP_packed_msg_t * msg)
{
    if (msg->tmp_buf) {
