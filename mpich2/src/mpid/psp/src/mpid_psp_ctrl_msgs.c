...
void MPIDI_PSP_IprobeCtrl(int tag, int recvcontext_id, int src_rank, pscom_connection_t *con, enum MPID_PSP_MSGTYPE msgtype, int *flag)
{
	pscom_request_t *req = PSCOM_REQUEST_CREATE();
...
void MPIDI_PSP_SendPartitionedCtrl(int tag, int context_id, int src_rank,
						...
						MPIR_Request * sreq, MPIR_Request * rreq, enum MPID_PSP_MSGTYPE msgtype)
{
